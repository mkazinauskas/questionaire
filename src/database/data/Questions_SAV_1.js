...
const QUESTIONS_SAV_1 = new TestGroup(
    'SAV_1', [
    new Question(
    ...
    new Question(
        'Kas organizuoja pirmosios pagalbos suteikiamą darbuotojams?',
        [
            new Answer(
    ...
    new Question(
        ...
        [
            new Answer(
                'darbuotojo įkvėpiamame ore esančių neaiškios kilmės cheminių medžiagų kiekis',
                false
            ),
            new Answer(
    ...
    new Question(
        ...
        [
            new Answer(
                'poilsio, persirengimo, drabužių, avalynės, asmeninių apsaugos priemonių laikymo patalpos arba vietos, sanitarinės bei asmens higienos patalpos su prausyklomis dušais ir tualetais',
                true
            ),
            new Answer(
...
export default QUESTIONS_SAV_1;